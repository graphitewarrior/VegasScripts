/**
	...
	By Tommy Marplatt - December 2015
  	...
  	Fixed script portal and UI compatibility by graphitewarrior - February 2026
...
public class EntryPoint
{
	...
	DialogResult DoDialog(Vegas vegas)
	{
		...
		l.ColumnCount = 2;
		l.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 500));
		l.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 200));
		...
		label.Margin = new Padding(20, 20, 20, 20);
		label.AutoSize = true;
		...
		SkewInBox.Margin= new Padding(20, 20, 20, 20);
		...
		SkewXYBox.Margin= new Padding(20, 20, 20, 20);
		...
		SkewOutBox.Margin= new Padding(20, 20, 20, 20);
		...
		XToYBox.Margin= new Padding(20, 20, 20, 20);
		...
		SRP.AutoSize = true;
		SRP.Margin = new Padding(20, 20, 20, 20);
		...
		SCF.AutoSize = true;
		SCF.Margin = new Padding(20, 20, 20, 20);
